...
namespace Drupal\moderation\Plugin\views\join;
 ...
 *
 * @ViewsJoin("moderation_join")
 */
class ModerationJoin extends JoinPluginBase {
...
//    ];
//    \Drupal::moduleHandler()->alter('moderation_join', $view_args, $context);
